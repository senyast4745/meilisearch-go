...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo7(in *jlexer.Lexer, out *Query) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "AttributesToCrop":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToCrop = append(out.AttributesToCrop, v43)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "AttributesToHighlight":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToHighlight = append(out.AttributesToHighlight, v44)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "FacetsDistribution":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.FacetsDistribution = append(out.FacetsDistribution, v45)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo7(out *jwriter.Writer, in Query) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.AttributesToRetrieve == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v46, v47 := range in.AttributesToRetrieve {
				if v46 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AttributesToCrop == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v48, v49 := range in.AttributesToCrop {
				if v48 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.AttributesToHighlight == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v50, v51 := range in.AttributesToHighlight {
				if v50 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.FacetsDistribution == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v52, v53 := range in.FacetsDistribution {
				if v52 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo8(in *jlexer.Lexer, out *PrimaryKey) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo8(out *jwriter.Writer, in PrimaryKey) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo9(in *jlexer.Lexer, out *Name) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo9(out *jwriter.Writer, in Name) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo10(in *jlexer.Lexer, out *ListDocumentsRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "attributesToRetrieve":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.AttributesToRetrieve = append(out.AttributesToRetrieve, v54)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo10(out *jwriter.Writer, in ListDocumentsRequest) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Offset != 0 {
	...
	if len(in.AttributesToRetrieve) != 0 {
		...
		{
			out.RawByte('[')
			for v55, v56 := range in.AttributesToRetrieve {
				if v55 > 0 {
					out.RawByte(',')
				}
...
func easyjson6601e8cdDecodeGithubComMeilisearchMeilisearchGo11(in *jlexer.Lexer, out *Keys) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComMeilisearchMeilisearchGo11(out *jwriter.Writer, in Keys) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Public != "" {
